...
def get_args():
    ...
    # Method and setting
    parser.add_argument('--rng_seed', type=int, default=301)
    ...
    parser.add_argument('--swap_every', type=int, default=500)
    parser.add_argument('--swap_threshold_perp', type=float, default=12.88)
    parser.add_argument('--swap_threshold_rec', type=float, default=0.188)
    ...
    parser.add_argument('--iteration_size', type=int, default=50)
